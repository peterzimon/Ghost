...
const switchThumbVariants = cva(
    'filter-[drop-shadow(0_1px_2px_rgba(0,0,0,0.07))] pointer-events-none block rounded-full bg-background ring-0 transition-transform data-[state=unchecked]:translate-x-0',
    {
        variants: {
            size: {
