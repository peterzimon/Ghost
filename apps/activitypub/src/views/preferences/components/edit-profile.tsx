                ...
                <FormField
                    ...
                    render={({field}) => (
                        <FormItem>
                            ...
                            <FormControl>
                                <div className='focus-within:outline-hidden relative flex items-center justify-stretch gap-1 rounded-md border border-transparent bg-gray-150 px-3 transition-colors focus-within:border-green focus-within:bg-transparent focus-within:shadow-[0_0_0_2px_rgba(48,207,67,.25)] dark:bg-gray-900'>
                                    <LucideIcon.AtSign className='w-4 min-w-4 text-gray-700' size={16} />
                                    <Input className='!outline-hidden w-auto grow !border-none bg-transparent px-0 !shadow-none' placeholder="index" {...field} />
